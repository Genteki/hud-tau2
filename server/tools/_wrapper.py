...
class Tau2ToolWrapper(BaseTool):
    ...
    def __init__(self, tau2_tool: Tool, toolkit: ToolKitBase):
        ...
        # Extract parameter schema from tau2 tool's Pydantic params model
        # This is critical for the LLM to know what parameters to pass
        if hasattr(tau2_tool.params, 'model_json_schema'):
            self._param_schema = tau2_tool.params.model_json_schema()
        else:
            self._param_schema = {"type": "object", "properties": {}}
    ...
    def mcp(self):
        ...
        if not hasattr(self, "_mcp_tool"):
            ...
            # Override the parameters with our extracted schema
